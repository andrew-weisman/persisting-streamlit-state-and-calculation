...
To clear the state, press the "Clear states" button below.
    ...
    button_text = 'Generate sequence'; args = (generate_sequence, number); kwargs = {'seconds_to_wait': number2, 'iterations_to_run': number3}  # swap this line out for a different one to run a different long-running function with different arguments
